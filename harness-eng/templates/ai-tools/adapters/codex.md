...
对齐程度：**部分（P2）·不默认**。与 Cursor/Claude/Qoder/WorkBuddy/Trae（高）不同，**不要**假设 Codex 已全量同步 rules / hooks / MCP / skills。**未探测到 `.codex/` 时不进「全部推荐」**；勿因习惯勾选。矩阵见 [ai-tools.md](../../../host/ai-tools.md)。
