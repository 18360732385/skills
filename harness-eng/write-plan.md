...
> **Codex = 部分对齐（P2）**：本轮 land / L5 `sync.mjs` **不会**全量发出 Codex 的 rules / hooks / MCP / skills。不要当成与 Cursor/Claude 全家桶对等。详见 [adapters/codex.md](templates/ai-tools/adapters/codex.md)。
