...
**0.6.1-dev Trae P0 spike 已开工**（2026-09-12）：官方实证 [TRAE-P0-EVIDENCE.md](TRAE-P0-EVIDENCE.md)；镜像保留 Trae frontmatter；`mature-trae` fixture。**不塞进已收口的 0.6.0**。G6 仍只管 Codex P2 冻结，与本条无关。
