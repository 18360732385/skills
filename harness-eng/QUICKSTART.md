...
0.6.1 Trae 高：[host/TRAE-P0-EVIDENCE.md](host/TRAE-P0-EVIDENCE.md)。0.6.4-dev CodeBuddy：[host/CODEBUDDY-PARITY.md](host/CODEBUDDY-PARITY.md)。0.6.0 计划（已收口）：[ROADMAP-0.6.0.md](ROADMAP-0.6.0.md)。  
版本见 [CHANGELOG.md](CHANGELOG.md)（当前 **0.6.4-dev**）。
