...
- [ ] 若选用 Codex：已告知 **P2 / 部分对齐（P0 解冻·仍不默认）** — `sync.mjs` **不**全量分发 Codex rules/MCP/skills（hooks/config example + skills 轻指针除外；见 [adapters/codex.md](../templates/ai-tools/adapters/codex.md) · [CODEX-PARITY.md](../host/CODEX-PARITY.md)）
