...
| 语义验收 | `acceptance-check` | 深真全闸；merge/close 前置 | `scripts/acceptance-check.mjs` · [truth-quality.md](truth-quality.md) |
...
| 场景 | 路径 |
|---|---|
| **大仓首次** | [pipeline.md](pipeline.md) 骨架 Done ∧ 填充 MCP 闸 → [pipeline-fill.md](pipeline-fill.md) |
