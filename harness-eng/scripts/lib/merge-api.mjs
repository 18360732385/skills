...
function runAcceptance(workDir, gold, scriptsDir) {
...
export function mergeApi(args) {
  ...
  if (needAcceptance) {
    const acc = runAcceptance(workDir, args.gold, args.scriptsDir || path.join(__dirname, ".."));
    report.acceptance = {
      status: acc.status,
