# CodeBuddy / WorkBuddy → 官方对齐清单（0.6.4-dev）

harness-eng **0.6.4-dev** 把 WorkBuddy（目录名 `.codebuddy`）生成物对齐官方 CodeBuddy CLI / IDE 文档，同时**不假装**走 Cursor 协议（hooks 仍是 Claude 族；MCP 仍走仓库根 `.mcp.json`）。
