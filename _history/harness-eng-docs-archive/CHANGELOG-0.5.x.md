# harness-eng CHANGELOG（0.5.x · 已迁出热路径）

> 从热路径 [CHANGELOG.md](../CHANGELOG.md) 迁出。现行列车从 **0.6.0** 起见热路径文件。
...
全文指针：仓库 `_history/harness-eng-docs-archive/CHANGELOG-through-0.4.md`。

0.4.0 及更早条目已归档：[CHANGELOG-through-0.4.md](../../_history/harness-eng-docs-archive/CHANGELOG-through-0.4.md)。
